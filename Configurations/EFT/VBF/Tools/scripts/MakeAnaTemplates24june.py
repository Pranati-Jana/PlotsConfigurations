...
src = "rootFileWHlep16_7july/plots_WHlep16_7july.root"
dst_hvv = "rootFileWHlep16_7july/plots_JJH_HVV.root"
dst_hgg = "rootFileWHlep16_7july/plots_JJH_HGG.root"
...
def AddOtherTemplates(Cat, Var, Prod, AC):
 ...
 fout.cd("hww2l2v_13TeV_"+Cat+"/BDTG_WH"+"/")
# fout.cd("hww2l2v_13TeV_"+Cat+"/BDTG_ZH"+"/") 
...
def getSumOfRWHVVSamples(f, BaseN, Hyp ): 

 if Hyp == "H0PM" : H1 = f.Get(''+BaseN+'H0PM'+'') 
 else             : H1 = f.Get(''+BaseN+'H0PM_'+Hyp+'') 
 if Hyp == "H0M" :  H2 = f.Get(''+BaseN+'H0M'+'') 
 else            :  H2 = f.Get(''+BaseN+'H0M_'+Hyp+'')
 if Hyp == "H0PH" : H3 = f.Get(''+BaseN+'H0PH'+'')
 else             : H3 = f.Get(''+BaseN+'H0PH_'+Hyp+'')
 if Hyp == "H0L1" : H4 = f.Get(''+BaseN+'H0L1'+'') 
 else             : H4 = f.Get(''+BaseN+'H0L1_'+Hyp+'') 
 if Hyp == "H0Mf05" :  H5 = f.Get(''+BaseN+'H0Mf05'+'') 
 else               :  H5 = f.Get(''+BaseN+'H0Mf05_'+Hyp+'') 
 if Hyp == "H0PHf05" : H6 = f.Get(''+BaseN+'H0PHf05'+'')
 else                : H6 = f.Get(''+BaseN+'H0PHf05_'+Hyp+'')
 if Hyp == "H0L1f05" : H7 = f.Get(''+BaseN+'H0L1f05'+'')
 else                : H7 = f.Get(''+BaseN+'H0L1f05_'+Hyp+'')
...
def getSumOfRWHGGSamples(f, BaseN, Hyp): 

 if Hyp == "H0PM" : H1 = f.Get(''+BaseN+'H0PM'+'') 
 else             : H1 = f.Get(''+BaseN+'H0PM_'+Hyp+'') 
 if Hyp == "H0M" :  H2 = f.Get(''+BaseN+'H0M'+'') 
 else            :  H2 = f.Get(''+BaseN+'H0M_'+Hyp+'')
 if Hyp == "H0Mf05" :  H3 = f.Get(''+BaseN+'H0Mf05'+'') 
 else               :  H3 = f.Get(''+BaseN+'H0Mf05_'+Hyp+'') 
...
def create2VIntTemplates(Cat, Var, Prod, AC,  Test):

 print " " 
 print " ", Cat, Var, Prod, AC,  Test
 print " " 

 f = ROOT.TFile.Open(''+src+'', 'read')
 BaseN = "hww2l2v_13TeV_"+Cat+"/"+Var+"/histo_"+Prod+""

 SM = getSumOfRWHVVSamples(f, BaseN, "H0PM")
 M0 = getSumOfRWHVVSamples(f, BaseN, AC+"_M0")
 M1 = getSumOfRWHVVSamples(f, BaseN, AC+"_M1")
 M2 = getSumOfRWHVVSamples(f, BaseN, AC+"_M2")
 M3 = getSumOfRWHVVSamples(f, BaseN, AC+"_M3")

 SM_Org  = f.Get(''+BaseN+'H0PM'+'')
 BSM_Org = f.Get(''+BaseN+AC+'')
 f05_Org = f.Get(''+BaseN+AC+'f05'+'')
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasf05.SaveAs("plotWHlep16_7july/f05_"+Cat+"_"+Var+"_"+Prod+AC+".pdf")
  canvasf05.SaveAs("plotWHlep16_7july/f05_"+Cat+"_"+Var+"_"+Prod+AC+".png")
  ...
  legend.Draw()
  canvasT1.SaveAs("plotWHlep16_7july/T1_"+Cat+"_"+Var+"_"+Prod+AC+".pdf")
  canvasT1.SaveAs("plotWHlep16_7july/T1_"+Cat+"_"+Var+"_"+Prod+AC+".png")
  ...
  legend.Draw()
  canvasT2.SaveAs("plotWHlep16_7july/T2_"+Cat+"_"+Var+"_"+Prod+AC+".pdf")
  canvasT2.SaveAs("plotWHlep16_7july/T2_"+Cat+"_"+Var+"_"+Prod+AC+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT3.SaveAs("plotWHlep16_7july/T3_"+Cat+"_"+Var+"_"+Prod+AC+".pdf")
  canvasT3.SaveAs("plotWHlep16_7july/T3_"+Cat+"_"+Var+"_"+Prod+AC+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT4.SaveAs("plotWHlep16_7july/T4_"+Cat+"_"+Var+"_"+Prod+AC+".pdf")
  canvasT4.SaveAs("plotWHlep16_7july/T4_"+Cat+"_"+Var+"_"+Prod+AC+".png")
  ...
  legend.Draw()
  canvasT5.SaveAs("plotWHlep16_7july/T5_"+Cat+"_"+Var+"_"+Prod+AC+".pdf")
  canvasT5.SaveAs("plotWHlep16_7july/T5_"+Cat+"_"+Var+"_"+Prod+AC+".png")
 ...
 if AC == "H0L1" and (Prod == "VBF_") and Cat == "SRWH_ossf" :
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasFinal.SaveAs("plotWHlep16_7july/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+".pdf")
  canvasFinal.SaveAs("plotWHlep16_7july/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+".png")

  canvasScan = ROOT.TCanvas('canvasScan', '', 500, 500)
  gr.Draw("ALP")
#  canvasScan.SetLogy()
  canvasScan.SaveAs("plotWHlep16_7july/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+".pdf")
  canvasScan.SaveAs("plotWHlep16_7july/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+".png")

 fout = ROOT.TFile.Open(''+dst_hvv+'', 'update')
 ROOT.gDirectory.mkdir("hww2l2v_13TeV_"+Cat+"/BDTG_WH"+"/")
# ROOT.gDirectory.mkdir("hww2l2v_13TeV_"+Cat+"/BDTG_ZH"+"/")
 fout.cd("hww2l2v_13TeV_"+Cat+"/BDTG_WH"+"/")
# fout.cd("hww2l2v_13TeV_"+Cat+"/BDTG_ZH"+"/")
...
# fout.cd("hww2l2v_13TeV_"+Cat+"/KD_"+AC+"/")
 ...
 T1.SetName("histo_"+Prod+"T1"+"")
 T2.SetName("histo_"+Prod+"T2"+"")
 T3.SetName("histo_"+Prod+"T3"+"")
 T4.SetName("histo_"+Prod+"T4"+"")
 T5.SetName("histo_"+Prod+"T5"+"")
...
def create1VIntTemplates(Cat, Var, Prod, AC, Test):
 ...
 if Prod is "GGHjj_" :
  dst = dst_hgg
  SM  = getSumOfRWHGGSamples(f, BaseN, "H0PM")
  BSM = getSumOfRWHGGSamples(f, BaseN, AC)
  f05 = getSumOfRWHGGSamples(f, BaseN, AC+"f05")
 else :
  dst = dst_hvv
  SM  = getSumOfRWHVVSamples(f, BaseN, "H0PM")
  BSM = getSumOfRWHVVSamples(f, BaseN, AC)
  f05 = getSumOfRWHVVSamples(f, BaseN, AC+"f05")
...
#  canvasScan.SetLogy()
 ...
 T1.SetName("histo_ggH_T1"+"") 
 T2.SetName("histo_ggH_T2"+"")
 T3.SetName("histo_ggH_T3"+"")
...
'''
VBFConfig = [ #("SRWH_sssf", "BDTG_WH", "VBF_", "H0M"),
              #("SRWH_sssf", "BDTG_WH", "VBF_", "H0PH"),
              #("SRWH_sssf", "BDTG_WH", "VBF_", "H0L1"),
              ("SRWH_ossf",  "BDTG_WH",  "VBF_", "H0M"),
              ("SRWH_ossf",  "BDTG_WH",  "VBF_", "H0PH"),
              ("SRWH_ossf",  "BDTG_WH",  "VBF_", "H0L1"),   
              ("SRWH_sssf",  "BDTG_WH",  "VBF_", "H0M"),
              ("SRWH_sssf",  "BDTG_WH",  "VBF_", "H0PH"),
              ("SRWH_sssf",  "BDTG_WH",  "VBF_", "H0L1"),
              ("merged",  "BDTG_WH",  "VBF_", "H0M"),
              ("merged",  "BDTG_WH",  "VBF_", "H0PH"),
              ("merged",  "BDTG_WH",  "VBF_", "H0L1"),
              ("SRZH",  "BDTG_WH",  "VBF_", "H0M"),
              ("SRZH",  "BDTG_WH",  "VBF_", "H0PH"),
              ("SRZH",  "BDTG_WH",  "VBF_", "H0L1"),
              ("wz", "events", "VBF_", "H0M"),
              ("wz", "events", "VBF_", "H0PH"),
              ("wz", "events", "VBF_", "H0L1"),
              ("zg", "events", "VBF_", "H0M"),
...
WHConfig = [  ("SRWH_sssf", "BDTG_WH", "WH_", "H0M"),
              ("SRWH_sssf", "BDTG_WH", "WH_", "H0PH"),
              ("SRWH_sssf", "BDTG_WH", "WH_", "H0L1"),
              ("SRWH_ossf",  "BDTG_WH",  "WH_", "H0M"),
              ("SRWH_ossf",  "BDTG_WH",  "WH_", "H0PH"),
              ("SRWH_ossf",  "BDTG_WH",  "WH_", "H0L1"), 
              ("SRWH_merged",  "BDTG_WH",  "WH_", "H0M"),
              ("SRWH_merged",  "BDTG_WH",  "WH_", "H0PH"),
              ("SRWH_merged",  "BDTG_WH",  "WH_", "H0L1"),
              ("SRZH",  "BDTG_WH",  "WH_", "H0M"),
              ("SRZH",  "BDTG_WH",  "WH_", "H0PH"),
              ("SRZH",  "BDTG_WH",  "WH_", "H0L1"),
              ("wz", "events", "WH_", "H0M"),
              ("wz", "events", "WH_", "H0PH"),
              ("wz", "events", "WH_", "H0L1"),
              ("zg", "events", "WH_", "H0M"),
...
'''
VHConfig = [  ("SRWH_sssf", "BDTG_WH", "VH_", "H0M"),
              ("SRWH_sssf", "BDTG_WH", "VH_", "H0PH"),
              ("SRWH_sssf", "BDTG_WH", "VH_", "H0L1"),
              ("SRWH_ossf",  "BDTG_WH",  "VH_", "H0M"),
              ("SRWH_ossf",  "BDTG_WH",  "VH_", "H0PH"),
              ("SRWH_ossf",  "BDTG_WH",  "VH_", "H0L1"),  
              ("SRVH",  "BDTG_WH",  "VH_", "H0M"),
              ("SRVH",  "BDTG_WH",  "VH_", "H0PH"),
              ("SRVH",  "BDTG_WH",  "VH_", "H0L1"),
              ("SRZH",  "BDTG_WH",  "VH_", "H0M"),
              ("SRZH",  "BDTG_WH",  "VH_", "H0PH"),
              ("SRZH",  "BDTG_WH",  "VH_", "H0L1"),
              ("top_of0j", "events", "VH_", "H0M"),
              ("top_of0j", "events", "VH_", "H0PH"),
              ("top_of0j", "events", "VH_", "H0L1"),
              ("wz", "events", "VH_", "H0M"),
              ("wz", "events", "VH_", "H0PH"),
              ("wz", "events", "VH_", "H0L1"),
]
'''
ZHConfig = [  ("SRWH_sssf", "BDTG_WH", "ZH_", "H0M"),
              ("SRWH_sssf", "BDTG_WH", "ZH_", "H0PH"),
              ("SRWH_sssf", "BDTG_WH", "ZH_", "H0L1"),
              ("SRWH_ossf",  "BDTG_WH",  "ZH_", "H0M"),
              ("SRWH_ossf",  "BDTG_WH",  "ZH_", "H0PH"),
              ("SRWH_ossf",  "BDTG_WH",  "ZH_", "H0L1"),
              ("SRWH_merged",  "BDTG_WH",  "ZH_", "H0M"),
              ("SRWH_merged",  "BDTG_WH",  "ZH_", "H0PH"),
              ("SRWH_merged",  "BDTG_WH",  "ZH_", "H0L1"),
              ("SRZH",  "BDTG_WH",  "ZH_", "H0M"),
              ("SRZH",  "BDTG_WH",  "ZH_", "H0PH"),
              ("SRZH",  "BDTG_WH",  "ZH_", "H0L1"),
              ("wz", "events", "ZH_", "H0M"),
              ("wz", "events", "ZH_", "H0PH"),
              ("wz", "events", "ZH_", "H0L1"),
              ("zg", "events", "ZH_", "H0M"),
...
'''
BVHConfig = [ ("SRWH_sssf", "BDTG_WH", "BVH_", "H0M"),
              ("SRWH_sssf", "BDTG_WH", "BVH_", "H0PH"),
              ("SRWH_sssf", "BDTG_WH", "BVH_", "H0L1"),
              ("SRWH_ossf",  "BDTG_WH",  "BVH_", "H0M"),
              ("SRWH_ossf",  "BDTG_WH",  "BVH_", "H0PH"),
              ("SRWH_ossf",  "BDTG_WH",  "BVH_", "H0L1"),
              ("SRVH",  "BDTG_WH",  "BVH_", "H0M"),
              ("SRVH",  "BDTG_WH",  "BVH_", "H0PH"),
              ("SRVH",  "BDTG_WH",  "BVH_", "H0L1"),
              ("SRBVH",  "BDTG_WH",  "BVH_", "H0M"),
              ("SRBVH",  "BDTG_WH",  "BVH_", "H0PH"),
              ("SRBVH",  "BDTG_WH",  "BVH_", "H0L1"),
]

'''
#SigConfig2V = ZHConfig + WHConfig + VBFConfig
SigConfig2V = WHConfig + VBFConfig + ZHConfig 

GGHConfig = [ ("SRWH_sssf", "BDTG_WH", "", "H0M"),
              ("SRWH_sssf", "BDTG_WH", "", "H0PH"),
              ("SRWH_sssf", "BDTG_WH", "", "H0L1"),
              ("SRWH_ossf",  "BDTG_WH",  "", "H0M"),
              ("SRWH_ossf",  "BDTG_WH",  "", "H0PH"),
              ("SRWH_ossf",  "BDTG_WH",  "", "H0L1"),   
              ("SRWH_merged",  "BDTG_WH",  "", "H0M"),
              ("SRWH_merged",  "BDTG_WH",  "", "H0PH"),
              ("SRWH_merged",  "BDTG_WH",  "", "H0L1"),
              ("SRZH",  "BDTG_WH",  "", "H0M"),
              ("SRZH",  "BDTG_WH",  "", "H0PH"),
              ("SRZH",  "BDTG_WH",  "", "H0L1"), 
              ("wz", "events", "", "H0M"),
...
AddOtherTemplates("SRWH_sssf", "BDTG_WH", "H0M"),
AddOtherTemplates("SRWH_sssf", "BDTG_WH", "H0PH"),
AddOtherTemplates("SRWH_sssf", "BDTG_WH", "H0L1"),
AddOtherTemplates("SRWH_ossf",  "BDTG_WH", "H0M"),
AddOtherTemplates("SRWH_ossf",  "BDTG_WH", "H0PH"),
AddOtherTemplates("SRWH_ossf",  "BDTG_WH", "H0L1"),
AddOtherTemplates("merged",  "BDTG_WH", "H0M"),
AddOtherTemplates("merged",  "BDTG_WH", "H0PH"),
AddOtherTemplates("merged",  "BDTG_WH", "H0L1"),
AddOtherTemplates("SRZH",  "BDTG_WH", "H0M"),
AddOtherTemplates("SRZH",  "BDTG_WH", "H0PH"),
AddOtherTemplates("SRZH",  "BDTG_WH", "H0L1"),
AddOtherTemplates("wz", "events", "H0M"),
AddOtherTemplates("wz", "events", "H0PH"),
AddOtherTemplates("wz", "events", "H0L1"),
AddOtherTemplates("zg", "events", "H0M"),
AddOtherTemplates("zg", "events", "H0PH"),
AddOtherTemplates("zg", "events", "H0L1"),

'''
AddOtherTemplates("SRWH_sssf", "BDTG_ZH","", "H0M"),
AddOtherTemplates("SRWH_sssf", "BDTG_ZH","", "H0PH"),
AddOtherTemplates("SRWH_sssf", "BDTG_ZH","", "H0L1"),
AddOtherTemplates("SRWH_ossf",  "BDTG_ZH", "", "H0M"),
AddOtherTemplates("SRWH_ossf",  "BDTG_ZH", "", "H0PH"),
AddOtherTemplates("SRWH_ossf",  "BDTG_ZH", "", "H0L1"),
AddOtherTemplates("SRVH",  "BDTG_ZH", "", "H0M"),
AddOtherTemplates("SRVH",  "BDTG_ZH", "", "H0PH"),
AddOtherTemplates("SRVH",  "BDTG_ZH", "", "H0L1"),
AddOtherTemplates("SRZH",  "BDTG_ZH", "", "H0M"),
AddOtherTemplates("SRZH",  "BDTG_ZH", "", "H0PH"),
AddOtherTemplates("SRZH",  "BDTG_ZH", "", "H0L1"),
'''
'''
