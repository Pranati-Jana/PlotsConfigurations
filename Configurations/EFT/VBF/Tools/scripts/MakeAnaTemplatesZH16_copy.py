...
#      HistNameList.append(h.GetName())
 ...
 fout.cd("hww2l2v_13TeV_"+Cat+"/BDTG_ZH_"+AC+"/") 
...
# if T5.Integral() < 0 : print "T5 is bad!!!!", T5.Integral(), Cat, Var, Prod, AC, Sys, Test
 ...
 ROOT.gDirectory.mkdir("hww2l2v_13TeV_"+Cat+"/BDTG_ZH_"+AC+"/")
 fout.cd("hww2l2v_13TeV_"+Cat+"/BDTG_ZH_"+AC+"/")
...
VBFConfig = [ ("SRVBF", "BDTG_ZH", "VBF_", "H0M"),
              ("SRVBF", "BDTG_ZH", "VBF_", "H0PH"),
              ("SRVBF", "BDTG_ZH", "VBF_", "H0L1"),
              ("SRWH",  "BDTG_ZH",  "VBF_", "H0M"),
              ("SRWH",  "BDTG_ZH",  "VBF_", "H0PH"),
              ("SRWH",  "BDTG_ZH",  "VBF_", "H0L1"),
              ("SRZH",  "BDTG_ZH",  "VBF_", "H0M"),
              ("SRZH",  "BDTG_ZH",  "VBF_", "H0PH"),
              ("SRZH",  "BDTG_ZH",  "VBF_", "H0L1"),
#              ("ZZ_13TeV", "events", "VBF_", "H0M"),
#              ("ZZ_13TeV", "events", "VBF_", "H0PH"),
#              ("ZZ_13TeV", "events", "VBF_", "H0L1"),
              ("ZZ_MET_13TeV", "events", "VBF_", "H0M"),
              ("ZZ_MET_13TeV", "events", "VBF_", "H0PH"),
              ("ZZ_MET_13TeV", "events", "VBF_", "H0L1"),
]

WHConfig = [ ("SRVBF", "BDTG_ZH", "WH_", "H0M"),
              ("SRVBF", "BDTG_ZH", "WH_", "H0PH"),
              ("SRVBF", "BDTG_ZH", "WH_", "H0L1"),
              ("SRWH",  "BDTG_ZH",  "WH_", "H0M"),
              ("SRWH",  "BDTG_ZH",  "WH_", "H0PH"),
              ("SRWH",  "BDTG_ZH",  "WH_", "H0L1"),
              ("SRZH",  "BDTG_ZH",  "WH_", "H0M"),
              ("SRZH",  "BDTG_ZH",  "WH_", "H0PH"),
              ("SRZH",  "BDTG_ZH",  "WH_", "H0L1"),
#              ("ZZ_13TeV", "events", "WH_", "H0M"),
#              ("ZZ_13TeV", "events", "WH_", "H0PH"),
#              ("ZZ_13TeV", "events", "WH_", "H0L1"),
              ("ZZ_MET_13TeV", "events", "WH_", "H0M"),
              ("ZZ_MET_13TeV", "events", "WH_", "H0PH"),
              ("ZZ_MET_13TeV", "events", "WH_", "H0L1"),
]

ZHConfig = [  ("SRVBF", "BDTG_ZH", "ZH_", "H0M"),
              ("SRVBF", "BDTG_ZH", "ZH_", "H0PH"),
              ("SRVBF", "BDTG_ZH", "ZH_", "H0L1"),
              ("SRWH",  "BDTG_ZH",  "ZH_", "H0M"),
              ("SRWH",  "BDTG_ZH",  "ZH_", "H0PH"),
              ("SRWH",  "BDTG_ZH",  "ZH_", "H0L1"),
              ("SRZH",  "BDTG_ZH",  "ZH_", "H0M"),
              ("SRZH",  "BDTG_ZH",  "ZH_", "H0PH"),
              ("SRZH",  "BDTG_ZH",  "ZH_", "H0L1"),
#              ("ZZ_13TeV", "events", "ZH_", "H0M"),
#              ("ZZ_13TeV", "events", "ZH_", "H0PH"),
#              ("ZZ_13TeV", "events", "ZH_", "H0L1"),
              ("ZZ_MET_13TeV", "events", "ZH_", "H0M"),
              ("ZZ_MET_13TeV", "events", "ZH_", "H0PH"),
              ("ZZ_MET_13TeV", "events", "ZH_", "H0L1"),
]

#SigConfig2V = WHConfig + VBFConfig + ZHConfig
SigConfig2V = WHConfig + ZHConfig

GGHConfig = [ ("SRVBF", "BDTG_ZH", "", "H0M"),
              ("SRVBF", "BDTG_ZH", "", "H0PH"),
              ("SRVBF", "BDTG_ZH", "", "H0L1"),
              ("SRWH",  "BDTG_ZH",  "", "H0M"),
              ("SRWH",  "BDTG_ZH",  "", "H0PH"),
              ...
              ("SRZH",  "BDTG_ZH",  "", "H0L1"),
#              ("ZZ_13TeV", "events", "", "H0M"),
#              ("ZZ_13TeV", "events", "", "H0PH"),
#              ("ZZ_13TeV", "events", "", "H0L1"),
              ("ZZ_MET_13TeV", "events", "", "H0M"),
              ("ZZ_MET_13TeV", "events", "", "H0PH"),
              ("ZZ_MET_13TeV", "events", "", "H0L1"),
]
...
AddOtherTemplates("SRWH",  "BDTG_ZH", "H0M"),
AddOtherTemplates("SRWH",  "BDTG_ZH", "H0PH"),
AddOtherTemplates("SRWH",  "BDTG_ZH", "H0L1"),
AddOtherTemplates("SRZH",  "BDTG_ZH", "H0M"),
AddOtherTemplates("SRZH",  "BDTG_ZH", "H0PH"),
AddOtherTemplates("SRZH",  "BDTG_ZH", "H0L1"),
#AddOtherTemplates("ZZ_13TeV", "events", "H0M"),
#AddOtherTemplates("ZZ_13TeV", "events", "H0PH"),
#AddOtherTemplates("ZZ_13TeV", "events", "H0L1"),
AddOtherTemplates("ZZ_MET_13TeV", "events", "H0M"),
AddOtherTemplates("ZZ_MET_13TeV", "events", "H0PH"),
AddOtherTemplates("ZZ_MET_13TeV", "events", "H0L1"),
