...
src = "rootFileWHlep16_8july/plots_WHlep16_8july.root"
dst_hvv = "rootFileWHlep16_8july/plots_JJH_HVV_less.root"
dst_hgg = "rootFileWHlep16_8july/plots_JJH_HGG.root"
...
#othertemp_hvv = ['DATA','WW','top','DY','Wg','Zg','WgS','ZgS','WZ','ZZ','VVV','Fake', 'ggH_htt','qqH_htt','ZH_htt','WH_htt']
#othertemp_hgg = ['DATA','WW','top','DY','qqH_htt','ggH_htt','WH_hww','ZH_hww','ggH_hww','qqH_hww','ggZH_hww']



'''
othertemp_hvv = ['DATA','WW','top','DY','qqH_htt','ggH_htt']
othertemp_hgg = ['DATA','WW','top','DY','qqH_htt','ggH_htt','WH_hww','ZH_hww','qqH_hww']
'''
...
def AddOtherTemplates(Cat, Var, Prod, AC):
 ...
 fout.cd("hww2l2v_13TeV_"+Cat+"/BDTG_WH_"+AC+"/")
...
def create2VIntTemplates(Cat, Var, Prod, AC, Sys, Test):
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasf05.SaveAs("plotWHlep16_8july/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasf05.SaveAs("plotWHlep16_8july/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT1.SaveAs("plotWHlep16_8july/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT1.SaveAs("plotWHlep16_8july/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT2.SaveAs("plotWHlep16_8july/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT2.SaveAs("plotWHlep16_8july/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT3.SaveAs("plotWHlep16_8july/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT3.SaveAs("plotWHlep16_8july/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT4.SaveAs("plotWHlep16_8july/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT4.SaveAs("plotWHlep16_8july/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT5.SaveAs("plotWHlep16_8july/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT5.SaveAs("plotWHlep16_8july/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasFinal.SaveAs("plotWHlep16_8july/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasFinal.SaveAs("plotWHlep16_8july/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")

  canvasScan = ROOT.TCanvas('canvasScan', '', 500, 500)
  gr.Draw("ALP")
#  canvasScan.SetLogy()
  canvasScan.SaveAs("plotWHlep16_8july/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScan.SaveAs("plotWHlep16_8july/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")

 fout = ROOT.TFile.Open(''+dst_hvv+'', 'update')
 ROOT.gDirectory.mkdir("hww2l2v_13TeV_"+Cat+"/BDTG_WH_"+AC+"/")
...
#  canvasScan.SetLogy()
 ...
 fout = ROOT.TFile.Open(''+dst+'', 'update')
# ROOT.gDirectory.mkdir("hww2l2v_13TeV_"+Cat+"/BDTG_"+Prod+"/")
 ROOT.gDirectory.mkdir("hww2l2v_13TeV_"+Cat+"/BDTG_WH_"+AC+"/")
 fout.cd("hww2l2v_13TeV_"+Cat+"/BDTG_WH_"+AC+"/")
...
VBFConfig = [# ("SRVBF", "BDTG_WH", "VBF_", "H0M"),
             # ("SRVBF", "BDTG_WH", "VBF_", "H0PH"),
             # ("SRVBF", "BDTG_WH", "VBF_", "H0L1"),
...
#              ("SRVH",  "BDTG_WH",  "VBF_", "H0M"),
#              ("SRVH",  "BDTG_WH",  "VBF_", "H0PH"),
#              ("SRVH",  "BDTG_WH",  "VBF_", "H0L1"),
              ("wz", "events", "VBF_", "H0M"),
              ("wz", "events", "VBF_", "H0PH"),
              ("wz", "events", "VBF_", "H0L1"),
              ("zg", "events", "VBF_", "H0M"),
...
for cat, var, prod, sig in SigConfig2V :
 ...
 for sys in Systematics :
  create2VIntTemplates(cat, var, prod, sig, "_"+sys+"Up", True)
  create2VIntTemplates(cat, var, prod, sig, "_"+sys+"Down", True)
...
#AddOtherTemplates("SRVBF", "BDTG_WH","", "H0M"),
#AddOtherTemplates("SRVBF", "BDTG_WH","", "H0PH"),
#AddOtherTemplates("SRVBF", "BDTG_WH","", "H0L1"),
...
#AddOtherTemplates("SRVH",  "BDTG_WH", "", "H0M"),
#AddOtherTemplates("SRVH",  "BDTG_WH", "", "H0PH"),
#AddOtherTemplates("SRVH",  "BDTG_WH", "", "H0L1"),
...
'''
'''
AddOtherTemplates("SRVBF", "BDTG_ZH","", "H0M"),
AddOtherTemplates("SRVBF", "BDTG_ZH","", "H0PH"),
AddOtherTemplates("SRVBF", "BDTG_ZH","", "H0L1"),
