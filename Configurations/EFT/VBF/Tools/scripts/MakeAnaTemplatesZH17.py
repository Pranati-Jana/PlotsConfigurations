...
src = "rootFileZH4l17/plots_ZH4l17.root"
dst_hvv = "rootFileZH4l17/plots_JJH_HVV.root"
dst_hgg = "rootFileZH4l17/plots_JJH_HGG.root"
...
# if Verbose is True :  
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasf05.SaveAs("plotZH4l17/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasf05.SaveAs("plotZH4l17/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT1.SaveAs("plotZH4l17/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT1.SaveAs("plotZH4l17/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT2.SaveAs("plotZH4l17/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT2.SaveAs("plotZH4l17/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT3.SaveAs("plotZH4l17/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT3.SaveAs("plotZH4l17/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT4.SaveAs("plotZH4l17/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT4.SaveAs("plotZH4l17/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT5.SaveAs("plotZH4l17/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT5.SaveAs("plotZH4l17/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
...
# if T5.Integral() < 0 : print "T5 is bad!!!!", T5.Integral(), Cat, Var, Prod, AC, Sys, Test
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasFinal.SaveAs("plotZH4l17/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasFinal.SaveAs("plotZH4l17/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")

  canvasScan = ROOT.TCanvas('canvasScan', '', 500, 500)
  gr.Draw("ALP")
  canvasScan.SaveAs("plotZH4l17/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScan.SaveAs("plotZH4l17/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  canvasScanSh.SaveAs("plotZH4l17/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScanSh.SaveAs("plotZH4l17/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
