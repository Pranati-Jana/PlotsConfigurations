...
src = "rootFileWHlep17_8july/plots_WHlep17_8july.root"
dst_hvv = "rootFileWHlep17_8july/plots_JJH_HVV.root"
dst_hgg = "rootFileWHlep17_8july/plots_JJH_HGG.root"
...
# if Verbose is True :  
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasf05.SaveAs("plotWHlep17_8july/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasf05.SaveAs("plotWHlep17_8july/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT1.SaveAs("plotWHlep17_8july/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT1.SaveAs("plotWHlep17_8july/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT2.SaveAs("plotWHlep17_8july/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT2.SaveAs("plotWHlep17_8july/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT3.SaveAs("plotWHlep17_8july/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT3.SaveAs("plotWHlep17_8july/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT4.SaveAs("plotWHlep17_8july/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT4.SaveAs("plotWHlep17_8july/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT5.SaveAs("plotWHlep17_8july/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT5.SaveAs("plotWHlep17_8july/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
...
# if T5.Integral() < 0 : print "T5 is bad!!!!", T5.Integral(), Cat, Var, Prod, AC, Sys, Test
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasFinal.SaveAs("plotWHlep17_8july/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasFinal.SaveAs("plotWHlep17_8july/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")

  canvasScan = ROOT.TCanvas('canvasScan', '', 500, 500)
  gr.Draw("ALP")
  canvasScan.SaveAs("plotWHlep17_8july/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScan.SaveAs("plotWHlep17_8july/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  canvasScanSh.SaveAs("plotWHlep17_8july/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScanSh.SaveAs("plotWHlep17_8july/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
