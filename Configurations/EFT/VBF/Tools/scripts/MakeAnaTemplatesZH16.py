...
src = "rootFileZH4l16_14july/plots_ZH4l16_14july.root"
dst_hvv = "rootFileZH4l16_14july/plots_JJH_HVV.root"
dst_hgg = "rootFileZH4l16_14july/plots_JJH_HGG.root"

#othertemp_hvv = ['DATA','top','Wg','Zg','WgS','ZgS','WZ','ZZ','VVV','Fake', 'ggH_htt','qqH_htt','ZH_htt','WH_htt']
#othertemp_hgg = ['DATA','top','qqH_htt','ggH_htt','WH_hww','ZH_hww','ggH_hww','qqH_hww','ggZH_hww']


othertemp_hvv = ['DATA','WW','ggWW','ttZ','Wg','Zg','ZZ','ZZhad','WZhad','WZ','VVV','WWW','ggH_htt','qqH_htt','ZH_htt','WH_htt']

othertemp_hgg = ['DATA','WW','ttZ','qqH_htt','ggH_htt','WH_hww','ZH_hww','qqH_hww','ggH_hww','ggZH_hww']
...
# if Verbose is True :  
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasf05.SaveAs("plotZH4l16_14july/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasf05.SaveAs("plotZH4l16_14july/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT1.SaveAs("plotZH4l16_14july/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT1.SaveAs("plotZH4l16_14july/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT2.SaveAs("plotZH4l16_14july/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT2.SaveAs("plotZH4l16_14july/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT3.SaveAs("plotZH4l16_14july/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT3.SaveAs("plotZH4l16_14july/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT4.SaveAs("plotZH4l16_14july/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT4.SaveAs("plotZH4l16_14july/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT5.SaveAs("plotZH4l16_14july/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT5.SaveAs("plotZH4l16_14july/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
...
#  if Verbose is True : print "--------- Force VBF H0L1 T4 positive - Compensate in model! "
 ...
 if "hww2l2v_13TeV_SRVBF" in Cat and Prod == "VBF_" and AC == "H0PH" :  
  T2.Scale(0)
 if "SRVH" in Cat and Prod == "VBF_" and AC == "H0L1" :  
  T3.Scale(0)
...
# if T5.Integral() < 0 : print "T5 is bad!!!!", T5.Integral(), Cat, Var, Prod, AC, Sys, Test
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasFinal.SaveAs("plotZH4l16_14july/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasFinal.SaveAs("plotZH4l16_14july/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")

  canvasScan = ROOT.TCanvas('canvasScan', '', 500, 500)
  gr.Draw("ALP")
  canvasScan.SaveAs("plotZH4l16_14july/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScan.SaveAs("plotZH4l16_14july/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  canvasScanSh.SaveAs("plotZH4l16_14july/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScanSh.SaveAs("plotZH4l16_14july/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")

 fout = ROOT.TFile.Open(''+dst_hvv+'', 'update')
 ROOT.gDirectory.mkdir(Cat+"/BDTG_ZH_"+AC+"/")
 fout.cd(Cat+"/BDTG_ZH_"+AC+"/")
...
Sys = [ "CMS_scale_e"+Yr, "CMS_scale_m"+Yr, "CMS_eff_m"+Yr, "CMS_eff_e"+Yr,
"CMS_scale_JESHF"+Yr, "CMS_scale_JESBBEC1","CMS_scale_JESRelativeSample"+Yr, "CMS_scale_JESEC2","CMS_scale_JESFlavorQCD","CMS_scale_JESBBEC1"+Yr,"CMS_scale_JESAbsolute", "CMS_scale_JESHF","CMS_scale_JESEC2"+Yr,"CMS_scale_JESAbsolute"+Yr,"CMS_scale_JESRelativeBal",
"CMS_btag_jes","CMS_btag_hf","CMS_btag_lf","CMS_btag_lfstats1"+Yr, "CMS_btag_lfstats2"+Yr,"CMS_btag_hfstats1"+Yr, "CMS_btag_hfstats2"+Yr,"CMS_btag_cferr1","CMS_btag_cferr2",
"CMS_PUID"+Yr,"CMS_scale_met"+Yr,
"CMS_eff_prefiring"+Yr,"CMS_eff_hwwtrigger"+Yr,
#"PS_ISR","PS_FSR" ]
]
...
VBFConfig = [ ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "VBF_", "H0M"),
              ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "VBF_", "H0PH"),
              ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "VBF_", "H0L1"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "VBF_", "H0M"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "VBF_", "H0PH"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "VBF_", "H0L1"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "VBF_", "H0M"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "VBF_", "H0PH"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "VBF_", "H0L1"),
              ("zh4l_ZZ_13TeV", "events", "VBF_", "H0M"),
              ("zh4l_ZZ_13TeV", "events", "VBF_", "H0PH"),
              ("zh4l_ZZ_13TeV", "events", "VBF_", "H0L1"),
              ("zh4l_ZZ_MET_13TeV", "events", "VBF_", "H0M"),
              ("zh4l_ZZ_MET_13TeV", "events", "VBF_", "H0PH"),
              ("zh4l_ZZ_MET_13TeV", "events", "VBF_", "H0L1"),
]

WHConfig = [ ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "WH_", "H0M"),
              ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "WH_", "H0PH"),
              ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "WH_", "H0L1"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "WH_", "H0M"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "WH_", "H0PH"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "WH_", "H0L1"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "WH_", "H0M"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "WH_", "H0PH"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "WH_", "H0L1"),
              ("zh4l_ZZ_13TeV", "events", "WH_", "H0M"),
              ("zh4l_ZZ_13TeV", "events", "WH_", "H0PH"),
              ("zh4l_ZZ_13TeV", "events", "WH_", "H0L1"),
              ("zh4l_ZZ_MET_13TeV", "events", "WH_", "H0M"),
              ("zh4l_ZZ_MET_13TeV", "events", "WH_", "H0PH"),
              ("zh4l_ZZ_MET_13TeV", "events", "WH_", "H0L1"),
]

ZHConfig = [  ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "ZH_", "H0M"),
              ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "ZH_", "H0PH"),
              ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "ZH_", "H0L1"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "ZH_", "H0M"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "ZH_", "H0PH"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "ZH_", "H0L1"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "ZH_", "H0M"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "ZH_", "H0PH"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "ZH_", "H0L1"),
              ("zh4l_ZZ_13TeV", "events", "ZH_", "H0M"),
              ("zh4l_ZZ_13TeV", "events", "ZH_", "H0PH"),
              ("zh4l_ZZ_13TeV", "events", "ZH_", "H0L1"),
              ("zh4l_ZZ_MET_13TeV", "events", "ZH_", "H0M"),
              ("zh4l_ZZ_MET_13TeV", "events", "ZH_", "H0PH"),
              ("zh4l_ZZ_MET_13TeV", "events", "ZH_", "H0L1"),
]

#SigConfig2V = WHConfig + VBFConfig + ZHConfig
SigConfig2V = WHConfig + ZHConfig

GGHConfig = [ ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "", "H0M"),
              ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "", "H0PH"),
              ("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "", "H0L1"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "", "H0M"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "", "H0PH"),
              ("hww2l2v_13TeV_SRWH",  "BDTG_ZH",  "", "H0L1"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "", "H0M"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "", "H0PH"),
              ("hww2l2v_13TeV_SRZH",  "BDTG_ZH",  "", "H0L1"),
              ("zh4l_ZZ_13TeV", "events", "", "H0M"),
              ("zh4l_ZZ_13TeV", "events", "", "H0PH"),
              ("zh4l_ZZ_13TeV", "events", "", "H0L1"),
              ("zh4l_ZZ_MET_13TeV", "events", "", "H0M"),
              ("zh4l_ZZ_MET_13TeV", "events", "", "H0PH"),
              ("zh4l_ZZ_MET_13TeV", "events", "", "H0L1"),
]
...
AddOtherTemplates("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "H0M"),
AddOtherTemplates("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "H0PH"),
AddOtherTemplates("hww2l2v_13TeV_SRVBF", "BDTG_ZH", "H0L1"),
AddOtherTemplates("hww2l2v_13TeV_SRWH",  "BDTG_ZH", "H0M"),
AddOtherTemplates("hww2l2v_13TeV_SRWH",  "BDTG_ZH", "H0PH"),
AddOtherTemplates("hww2l2v_13TeV_SRWH",  "BDTG_ZH", "H0L1"),
AddOtherTemplates("hww2l2v_13TeV_SRZH",  "BDTG_ZH", "H0M"),
AddOtherTemplates("hww2l2v_13TeV_SRZH",  "BDTG_ZH", "H0PH"),
AddOtherTemplates("hww2l2v_13TeV_SRZH",  "BDTG_ZH", "H0L1"),
AddOtherTemplates("zh4l_ZZ_13TeV", "events", "H0M"),
AddOtherTemplates("zh4l_ZZ_13TeV", "events", "H0PH"),
AddOtherTemplates("zh4l_ZZ_13TeV", "events", "H0L1"),
AddOtherTemplates("zh4l_ZZ_MET_13TeV", "events", "H0M"),
AddOtherTemplates("zh4l_ZZ_MET_13TeV", "events", "H0PH"),
AddOtherTemplates("zh4l_ZZ_MET_13TeV", "events", "H0L1"),
