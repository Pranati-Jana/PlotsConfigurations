...
src = "rootFileZH4l18/plots_ZH4l18.root"
dst_hvv = "rootFileZH4l18/plots_JJH_HVV.root"
dst_hgg = "rootFileZH4l18/plots_JJH_HGG.root"
...
othertemp_hvv = ['DATA','WW','ggWW','Wg','Zg','ZZ','ZZhad','WZhad','WZ','VVV','WWW','ggH_htt','qqH_htt','ZH_htt','WH_htt']

othertemp_hgg = ['DATA','WW','qqH_htt','ggH_htt','WH_hww','ZH_hww','qqH_hww','ggH_hww','ggZH_hww']
...
# if Verbose is True :  
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasf05.SaveAs("unblindplotZH4l18/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasf05.SaveAs("unblindplotZH4l18/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT1.SaveAs("unblindplotZH4l18/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT1.SaveAs("unblindplotZH4l18/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT2.SaveAs("unblindplotZH4l18/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT2.SaveAs("unblindplotZH4l18/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT3.SaveAs("unblindplotZH4l18/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT3.SaveAs("unblindplotZH4l18/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT4.SaveAs("unblindplotZH4l18/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT4.SaveAs("unblindplotZH4l18/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT5.SaveAs("unblindplotZH4l18/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT5.SaveAs("unblindplotZH4l18/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
...
# if T5.Integral() < 0 : print "T5 is bad!!!!", T5.Integral(), Cat, Var, Prod, AC, Sys, Test
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasFinal.SaveAs("unblindplotZH4l18/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasFinal.SaveAs("unblindplotZH4l18/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")

  canvasScan = ROOT.TCanvas('canvasScan', '', 500, 500)
  gr.Draw("ALP")
  canvasScan.SaveAs("unblindplotZH4l18/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScan.SaveAs("unblindplotZH4l18/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  canvasScanSh.SaveAs("unblindplotZH4l18/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScanSh.SaveAs("unblindplotZH4l18/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
