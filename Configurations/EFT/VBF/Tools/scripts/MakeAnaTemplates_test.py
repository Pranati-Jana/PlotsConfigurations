...
dst_hvv = "rootFileWHlep16_8july/plots_JJH_HVV.root"
...
# if T5.Integral() < 0 : print "T5 is bad!!!!", T5.Integral(), Cat, Var, Prod, AC, Sys, Test
 ...
 if Test == True :
  ...
  canvasScanSh.SaveAs("plotWHlep16_8july/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScanSh.SaveAs("plotWHlep16_8july/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
...
VBFConfig = [ ("SRWH", "BDTG_WH", "VBF_", "H0M"),
