...
src = "rootFileWHlep18_8july/plots_WHlep18_8july.root"
dst_hvv = "rootFileWHlep18_8july/plots_JJH_HVV.root"
dst_hgg = "rootFileWHlep18_8july/plots_JJH_HGG.root"

othertemp_hvv = ['DATA','top','Wg','Zg','WgS','ZgS','WZ','ZZ','VVV','Fake_me','Fake_em','ggH_htt','qqH_htt','ZH_htt','WH_htt']
othertemp_hgg = ['DATA','top','qqH_htt','ggH_htt','WH_hww','ZH_hww','ggH_hww','qqH_hww','ggZH_hww']


#othertemp_hvv = ['DATA','WW','WWewk','ggWW','top','DY','Dyemb','Vg','VgS_L','VgS_H','VZ','VVV','Fake','Fake_me','ggH_htt','qqH_htt','ZH_htt','WH_htt']
...
# if Verbose is True :  
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasf05.SaveAs("plotWHlep18_8july/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasf05.SaveAs("plotWHlep18_8july/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT1.SaveAs("plotWHlep18_8july/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT1.SaveAs("plotWHlep18_8july/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT2.SaveAs("plotWHlep18_8july/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT2.SaveAs("plotWHlep18_8july/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT3.SaveAs("plotWHlep18_8july/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT3.SaveAs("plotWHlep18_8july/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT4.SaveAs("plotWHlep18_8july/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT4.SaveAs("plotWHlep18_8july/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT5.SaveAs("plotWHlep18_8july/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT5.SaveAs("plotWHlep18_8july/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
...
#  if Verbose is True : print "--------- Force VBF H0L1 T4 positive - Compensate in model! "
 ...
 if "SRVBF" in Cat and Prod == "VBF_" and AC == "H0PH" :  
  T2.Scale(0)
...
# if T5.Integral() < 0 : print "T5 is bad!!!!", T5.Integral(), Cat, Var, Prod, AC, Sys, Test
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasFinal.SaveAs("plotWHlep18_8july/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasFinal.SaveAs("plotWHlep18_8july/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")

  canvasScan = ROOT.TCanvas('canvasScan', '', 500, 500)
  gr.Draw("ALP")
  canvasScan.SaveAs("plotWHlep18_8july/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScan.SaveAs("plotWHlep18_8july/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  canvasScanSh.SaveAs("plotWHlep18_8july/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScanSh.SaveAs("plotWHlep18_8july/FinalSH_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
...
VBFConfig = [ #("SRVBF", "BDTG_WH", "VBF_", "H0M"),
              ...
              ("SRWH",  "BDTG_WH",  "VBF_", "H0M"),
              ("SRWH",  "BDTG_WH",  "VBF_", "H0PH"),
              ("SRWH",  "BDTG_WH",  "VBF_", "H0L1"),
...
WHConfig = [  ("SRWH",  "BDTG_WH",  "WH_", "H0M"),
              ("SRWH",  "BDTG_WH",  "WH_", "H0PH"),
              ("SRWH",  "BDTG_WH",  "WH_", "H0L1"),
              ...
              ("merged",  "BDTG_WH",  "WH_", "H0M"),
              ("merged",  "BDTG_WH",  "WH_", "H0PH"),
              ("merged",  "BDTG_WH",  "WH_", "H0L1"),
...
ZHConfig = [  ("SRWH", "BDTG_WH", "ZH_", "H0M"),
              ("SRWH", "BDTG_WH", "ZH_", "H0PH"),
              ("SRWH", "BDTG_WH", "ZH_", "H0L1"),
              ...
              ("merged",  "BDTG_WH",  "ZH_", "H0M"),
              ("merged",  "BDTG_WH",  "ZH_", "H0PH"),
              ("merged",  "BDTG_WH",  "ZH_", "H0L1"),
...
AddOtherTemplates("SRWH", "BDTG_WH", "H0M"),
AddOtherTemplates("SRWH", "BDTG_WH", "H0PH"),
AddOtherTemplates("SRWH", "BDTG_WH", "H0L1"),
