...
src = path.realpath("rootFileJJH17mar/plots_JJH17mar.root")
...
# legend.AddEntry(SumW,"Wgt Sum","l")
 ...
 # canvasM.SetLogy()
 canvasM.SaveAs("plotJJH17mar/HVVRW_"+Cat+"_"+Var+"_"+Prod+Hyp+".pdf")
 canvasM.SaveAs("plotJJH17mar/HVVRW_"+Cat+"_"+Var+"_"+Prod+Hyp+".png")
...
def CompareHGGRW(Cat, Var, Prod, Hyp):
 ...
 # canvasM.SetLogy()
 canvasM.SaveAs("plotJJH17mar/HGGRW_"+Cat+"_"+Var+"_"+Prod+Hyp+".pdf")
 canvasM.SaveAs("plotJJH17mar/HGGRW_"+Cat+"_"+Var+"_"+Prod+Hyp+".png")

##########################################################

WHConfig = [  ("SRVH",  "BDTG_WH", "WH_", "H0PM"),
              ("SRVH",  "BDTG_WH", "WH_", "H0M_M0"),
              ("SRVH",  "BDTG_WH", "WH_", "H0M_M1"),
              ("SRVH",  "BDTG_WH", "WH_", "H0M_M2"),
              ("SRVH",  "BDTG_WH", "WH_", "H0M_M3"),
              ("SRVH",  "BDTG_WH", "WH_", "H0PH_M0"),
              ("SRVH",  "BDTG_WH", "WH_", "H0PH_M1"),
              ("SRVH",  "BDTG_WH", "WH_", "H0PH_M2"),
              ("SRVH",  "BDTG_WH", "WH_", "H0PH_M3"),
              ("SRVH",  "BDTG_WH", "WH_", "H0L1_M0"), 
              ("SRVH",  "BDTG_WH", "WH_", "H0L1_M1"), 
              ("SRVH",  "BDTG_WH", "WH_", "H0L1_M2"), 
              ("SRVH",  "BDTG_WH", "WH_", "H0L1_M3"), 
]
'''
ZHConfig = [  ("SRVH",  "BDTG_WH", "ZH_", "H0PM"),
              ("SRVH",  "BDTG_WH", "ZH_", "H0M_M0"),
              ("SRVH",  "BDTG_WH", "ZH_", "H0M_M1"),
              ("SRVH",  "BDTG_WH", "ZH_", "H0M_M2"),
              ("SRVH",  "BDTG_WH", "ZH_", "H0M_M3"),
              ("SRVH",  "BDTG_WH", "ZH_", "H0PH_M0"),
              ("SRVH",  "BDTG_WH", "ZH_", "H0PH_M1"),
              ("SRVH",  "BDTG_WH", "ZH_", "H0PH_M2"),
              ("SRVH",  "BDTG_WH", "ZH_", "H0PH_M3"),
              ("SRVH",  "BDTG_WH", "ZH_", "H0L1_M0"), 
              ("SRVH",  "BDTG_WH", "ZH_", "H0L1_M1"), 
              ("SRVH",  "BDTG_WH", "ZH_", "H0L1_M2"), 
              ("SRVH",  "BDTG_WH", "ZH_", "H0L1_M3"), 
]

'''
VBFConfig = [ ("SRVBF",  "BDTG_WH", "VBF_", "H0PM"),
              ("SRVBF",  "BDTG_WH", "VBF_", "H0M_M0"),
              ("SRVBF",  "BDTG_WH", "VBF_", "H0M_M1"),
              ("SRVBF",  "BDTG_WH", "VBF_", "H0M_M2"),
              ("SRVBF",  "BDTG_WH", "VBF_", "H0M_M3"),
              ("SRVBF",  "BDTG_WH", "VBF_", "H0PH_M0"),
              ("SRVBF",  "BDTG_WH", "VBF_", "H0PH_M1"),
              ("SRVBF",  "BDTG_WH", "VBF_", "H0PH_M2"),
              ("SRVBF",  "BDTG_WH", "VBF_", "H0PH_M3"),
              ("SRVBF",  "BDTG_WH", "VBF_", "H0L1_M0"), 
              ("SRVBF",  "BDTG_WH", "VBF_", "H0L1_M1"), 
              ("SRVBF",  "BDTG_WH", "VBF_", "H0L1_M2"), 
              ("SRVBF",  "BDTG_WH", "VBF_", "H0L1_M3"), 
]

GGFConfig = [ ("SRVBF",  "BDTG_WH", "", "H0PM"),
              ("SRVBF",  "BDTG_WH", "", "H0PM"),
              ("SRVBF",  "BDTG_WH", "", "H0M"),
              ("SRVBF",  "BDTG_WH", "", "H0Mf05"),           
              ("SRVBF",  "BDTG_WH", "", "H0PH"),
              ("SRVBF",  "BDTG_WH", "", "H0PHf05"),         
              ("SRVBF",  "BDTG_WH", "", "H0L1"),
              ("SRVBF",  "BDTG_WH", "", "H0L1f05"),     
              ("SRVH",   "BDTG_WH",  "", "H0PM"),
              ("SRVH",   "BDTG_WH",  "", "H0M"),
              ("SRVH",   "BDTG_WH",  "", "H0Mf05"),           
              ("SRVH",   "BDTG_WH",  "", "H0PH"),
              ("SRVH",   "BDTG_WH",  "", "H0PHf05"),         
              ("SRVH",   "BDTG_WH",  "", "H0L1"),
              ("SRVH",   "BDTG_WH",  "", "H0L1f05"),    
]

#SigConfig = GGFConfig + VBFConfig + ZHConfig + WHConfig
SigConfig = GGFConfig + VBFConfig + WHConfig
