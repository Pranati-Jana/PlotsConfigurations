...
src = "rootFileWHlep16/plots_WHlep16.root"
dst_hvv = "rootFileWHlep16/plots_JJH_HVV.root"
dst_hgg = "rootFileWHlep16/plots_JJH_HGG.root"
...
def create2VIntTemplates(Cat, Var, Prod, AC, Sys, Test):
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasf05.SaveAs("plotWHlep16/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasf05.SaveAs("plotWHlep16/f05_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT1.SaveAs("plotWHlep16/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT1.SaveAs("plotWHlep16/T1_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT2.SaveAs("plotWHlep16/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT2.SaveAs("plotWHlep16/T2_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT3.SaveAs("plotWHlep16/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT3.SaveAs("plotWHlep16/T3_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.SetTextSize(.04)
  legend.Draw()
  canvasT4.SaveAs("plotWHlep16/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT4.SaveAs("plotWHlep16/T4_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
  ...
  legend.Draw()
  canvasT5.SaveAs("plotWHlep16/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasT5.SaveAs("plotWHlep16/T5_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
 ...
 if Test == True :
  ...
  legend.Draw()
  canvasFinal.SaveAs("plotWHlep16/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasFinal.SaveAs("plotWHlep16/FinalT_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")

  canvasScan = ROOT.TCanvas('canvasScan', '', 500, 500)
  gr.Draw("ALP")
#  canvasScan.SetLogy()
  canvasScan.SaveAs("plotWHlep16/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".pdf")
  canvasScan.SaveAs("plotWHlep16/FinalS_"+Cat+"_"+Var+"_"+Prod+AC+Sys+".png")
